...
const Adoption2 = () => {
  return (
     <div className='bg-[#88B392] max-w-[1280px] max-h-[375px] rounded-xl lg:mx-20 md:mx-10 lg:pb-10 md:pb-6 lg:mb-16'>
          ...
          <div className='flex items-center pt-3.5'>
            ...
            <div className='flex gap-5'>
                ...
                <div className='w-[186px] p-3 flex flex-col items-start gap-3 rounded-[12px] bg-[#AEC6CF]'>
